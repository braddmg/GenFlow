...
Help() {
    ...
    echo "-F     (F)ASTA file(s). If you have more than one, provide file names separated by commas:"
    ...
    echo "       See https://merenlab.org/2016/11/08/pangenomics-v2/ for more information."
}
...
while getopts ":HF:g:T:G:F:N:I:" option; do
    case $option in
        H) # Display Help
            Help
            exit;;
