...
<br>
The heatmap, illustrating the results of the Average Nucleotide Identity (ANI) analysis, was created in R using the matrix generated by pyANI. Refer to [pyANI](https://github.com/widdowquinn/pyani) for more information <br>. You will have three different files with different color palettes in the folder. 
